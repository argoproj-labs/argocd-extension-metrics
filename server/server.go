...
func (ms *O11yServer) Run(ctx context.Context) {
	...
	r.GET("/extensions/metrics/applications/:application/groupkinds/:groupkind/rows/:row/graphs/:graph", ms.queryMetrics)
	r.GET("/extensions/metrics/applications/:application/groupkinds/:groupkind/dashboards", ms.dashboardConfig)
